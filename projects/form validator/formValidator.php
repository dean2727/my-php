...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (in_array($raw_name, $existing_users)) {
    $validation_error = $validation_error . "This name is taken. <br>"; 
  }
  else {
    $name = $raw_name;
  }
  ...
  $options = ["options" => ["min_range" => 0, "max_range" => 130]];
  if (filter_var(date("Y")-$raw_birth_year, FILTER_VALIDATE_INT, $options)) {
